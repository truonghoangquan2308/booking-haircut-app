...
const _3DPrintMesh = react.default.forwardRef(function _3DPrintMesh({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") _3DPrintMesh.propTypes = require_iconPropTypes.iconPropTypes;
