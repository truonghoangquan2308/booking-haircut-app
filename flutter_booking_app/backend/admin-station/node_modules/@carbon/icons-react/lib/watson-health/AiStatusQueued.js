...
const AiStatusQueued = react.default.forwardRef(function AiStatusQueued({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") AiStatusQueued.propTypes = require_iconPropTypes.iconPropTypes;
