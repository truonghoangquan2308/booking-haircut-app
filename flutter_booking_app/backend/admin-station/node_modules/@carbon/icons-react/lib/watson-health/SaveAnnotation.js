...
const SaveAnnotation = react.default.forwardRef(function SaveAnnotation({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") SaveAnnotation.propTypes = require_iconPropTypes.iconPropTypes;
