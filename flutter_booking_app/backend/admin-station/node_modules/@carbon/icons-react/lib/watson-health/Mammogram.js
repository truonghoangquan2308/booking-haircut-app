...
const Mammogram = react.default.forwardRef(function Mammogram({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") Mammogram.propTypes = require_iconPropTypes.iconPropTypes;
