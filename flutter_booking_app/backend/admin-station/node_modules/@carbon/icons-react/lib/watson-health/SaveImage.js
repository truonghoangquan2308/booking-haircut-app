...
const SaveImage = react.default.forwardRef(function SaveImage({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") SaveImage.propTypes = require_iconPropTypes.iconPropTypes;
