...
const AiStatusFailed = react.default.forwardRef(function AiStatusFailed({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") AiStatusFailed.propTypes = require_iconPropTypes.iconPropTypes;
