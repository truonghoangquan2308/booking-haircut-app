...
const ThumbnailPreview = react.default.forwardRef(function ThumbnailPreview({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") ThumbnailPreview.propTypes = require_iconPropTypes.iconPropTypes;
