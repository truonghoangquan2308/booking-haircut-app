...
const ZoomPan = react.default.forwardRef(function ZoomPan({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") ZoomPan.propTypes = require_iconPropTypes.iconPropTypes;
