...
const ImageAvailabilityLocal = react.default.forwardRef(function ImageAvailabilityLocal({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") ImageAvailabilityLocal.propTypes = require_iconPropTypes.iconPropTypes;
