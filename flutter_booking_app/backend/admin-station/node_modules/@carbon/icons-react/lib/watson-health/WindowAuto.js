...
const WindowAuto = react.default.forwardRef(function WindowAuto({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") WindowAuto.propTypes = require_iconPropTypes.iconPropTypes;
