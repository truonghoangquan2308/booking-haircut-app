...
const WindowPreset = react.default.forwardRef(function WindowPreset({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") WindowPreset.propTypes = require_iconPropTypes.iconPropTypes;
