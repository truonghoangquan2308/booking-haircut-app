...
const _3DSoftware = react.default.forwardRef(function _3DSoftware({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") _3DSoftware.propTypes = require_iconPropTypes.iconPropTypes;
