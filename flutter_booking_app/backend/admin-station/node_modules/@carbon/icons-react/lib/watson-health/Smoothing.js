...
const Smoothing = react.default.forwardRef(function Smoothing({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") Smoothing.propTypes = require_iconPropTypes.iconPropTypes;
