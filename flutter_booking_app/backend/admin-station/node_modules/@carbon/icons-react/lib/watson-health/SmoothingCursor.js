...
const SmoothingCursor = react.default.forwardRef(function SmoothingCursor({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") SmoothingCursor.propTypes = require_iconPropTypes.iconPropTypes;
