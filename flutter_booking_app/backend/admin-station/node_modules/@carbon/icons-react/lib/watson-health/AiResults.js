...
const AiResults = react.default.forwardRef(function AiResults({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") AiResults.propTypes = require_iconPropTypes.iconPropTypes;
