...
const AiStatusComplete = react.default.forwardRef(function AiStatusComplete({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") AiStatusComplete.propTypes = require_iconPropTypes.iconPropTypes;
