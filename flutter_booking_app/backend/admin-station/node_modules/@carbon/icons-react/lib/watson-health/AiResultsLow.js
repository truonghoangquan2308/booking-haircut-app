...
const AiResultsLow = react.default.forwardRef(function AiResultsLow({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") AiResultsLow.propTypes = require_iconPropTypes.iconPropTypes;
