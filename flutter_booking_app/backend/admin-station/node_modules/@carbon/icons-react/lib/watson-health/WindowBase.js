...
const WindowBase = react.default.forwardRef(function WindowBase({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") WindowBase.propTypes = require_iconPropTypes.iconPropTypes;
