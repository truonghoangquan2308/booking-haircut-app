...
const _3DCursor = react.default.forwardRef(function _3DCursor({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") _3DCursor.propTypes = require_iconPropTypes.iconPropTypes;
