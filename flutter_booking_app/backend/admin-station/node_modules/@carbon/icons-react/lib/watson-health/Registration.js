...
const Registration = react.default.forwardRef(function Registration({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") Registration.propTypes = require_iconPropTypes.iconPropTypes;
