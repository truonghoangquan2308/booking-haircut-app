...
const CrossReference = react.default.forwardRef(function CrossReference({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") CrossReference.propTypes = require_iconPropTypes.iconPropTypes;
