...
const AiResultsUrgent = react.default.forwardRef(function AiResultsUrgent({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") AiResultsUrgent.propTypes = require_iconPropTypes.iconPropTypes;
