...
const SubVolume = react.default.forwardRef(function SubVolume({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") SubVolume.propTypes = require_iconPropTypes.iconPropTypes;
