...
const SaveSeries = react.default.forwardRef(function SaveSeries({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") SaveSeries.propTypes = require_iconPropTypes.iconPropTypes;
