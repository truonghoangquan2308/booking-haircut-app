...
const AiStatusRejected = react.default.forwardRef(function AiStatusRejected({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") AiStatusRejected.propTypes = require_iconPropTypes.iconPropTypes;
