...
const AiResultsHigh = react.default.forwardRef(function AiResultsHigh({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") AiResultsHigh.propTypes = require_iconPropTypes.iconPropTypes;
