...
const ScalpelCursor = react.default.forwardRef(function ScalpelCursor({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") ScalpelCursor.propTypes = require_iconPropTypes.iconPropTypes;
