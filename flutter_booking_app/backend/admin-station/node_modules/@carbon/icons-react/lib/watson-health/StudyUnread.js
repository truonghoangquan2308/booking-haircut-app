...
const StudyUnread = react.default.forwardRef(function StudyUnread({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") StudyUnread.propTypes = require_iconPropTypes.iconPropTypes;
