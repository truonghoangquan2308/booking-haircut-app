...
const StudyView = react.default.forwardRef(function StudyView({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") StudyView.propTypes = require_iconPropTypes.iconPropTypes;
