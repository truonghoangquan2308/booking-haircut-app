...
const StatusChange = react.default.forwardRef(function StatusChange({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") StatusChange.propTypes = require_iconPropTypes.iconPropTypes;
