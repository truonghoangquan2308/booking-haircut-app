...
const Denominate = react.default.forwardRef(function Denominate({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") Denominate.propTypes = require_iconPropTypes.iconPropTypes;
