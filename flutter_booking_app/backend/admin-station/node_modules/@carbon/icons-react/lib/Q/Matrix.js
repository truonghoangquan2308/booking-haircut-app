...
const Matrix = react.default.forwardRef(function Matrix({ children, size = 16, ...rest }, ref) {
...
if (process.env.NODE_ENV !== "production") Matrix.propTypes = require_iconPropTypes.iconPropTypes;
