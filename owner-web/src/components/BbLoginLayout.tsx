...
/** Cùng layout với Flutter LoginScreen: nền vàng, header logo + pill navy, thẻ trắng. */
export function BbLoginLayout({
  ...
  return (
    <div className="min-h-screen overflow-y-auto bg-bb-yellow">
      {/*
        Căn giữa cả khối (logo + pill + thẻ) theo chiều dọc — tránh flex-1 justify-center
        tách thẻ xuống giữa màn hình tạo khoảng trống lớn dưới header.
      */}
